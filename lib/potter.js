...
(function() {
  var Canvas, Material, Potter, async, clay, error, fs, inspect, log, pot, rgbToHex, rgbToInt, setPixel, toRGBString, wait, _ref, _ref1,
  ...
  Material = (function() {
    ...
    Material.prototype.toString = function() {
      return "Material(id: " + this.id + ", name: " + this.name + ", color: " + this.color + ", type: " + this.type + ", rgb: (" + this.rgb.r + "," + this.rgb.g + "," + this.rgb.b + ")})";
    };
  ...
  pot.save("examples/exports/test.pcd", function() {
