...
(function() {
  ...
  module.exports = (function() {
    ...
    exports.prototype.filter = function(kernel) {
      return this.map(function(p, state) {
        if (kernel(p, state)) {
          return state;
        }
      });
    ...
    exports.prototype.reduce = function(accumulator, kernel) {
      var acc;
      acc = accumulator;
      this.map(function(p, state) {
        return acc = kernel(acc, p, state);
      });
      return acc;
    };

    exports.prototype.sum = function(kernel) {
      var acc;
      acc = 0;
      this.map(function(p, state) {
